 ...
 **/
@interface MatchaPBSwitchViewSwitchviewRoot : GPBRootObject
@end
...
typedef GPB_ENUM(MatchaPBSwitchViewView_FieldNumber) {
  ...
  MatchaPBSwitchViewView_FieldNumber_Enabled = 2,
};
...
typedef GPB_ENUM(MatchaPBSwitchViewEvent_FieldNumber) {
  MatchaPBSwitchViewEvent_FieldNumber_Value = 1,
};

@interface MatchaPBSwitchViewEvent : GPBMessage
