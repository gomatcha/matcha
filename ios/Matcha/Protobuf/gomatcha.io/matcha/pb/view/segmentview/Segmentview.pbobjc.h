 ...
 **/
@interface MatchaSegmentViewPbSegmentviewRoot : GPBRootObject
@end
...
@interface MatchaSegmentViewPbView : GPBMessage
...
typedef GPB_ENUM(MatchaSegmentViewPbEvent_FieldNumber) {
  MatchaSegmentViewPbEvent_FieldNumber_Value = 1,
};

@interface MatchaSegmentViewPbEvent : GPBMessage
