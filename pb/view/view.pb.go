...
func (*BuildNode) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*LayoutPaintNode) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*Root) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func init() { proto.RegisterFile("gomatcha.io/matcha/pb/view/view.proto", fileDescriptor1) }
