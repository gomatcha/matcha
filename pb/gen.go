...
//go:generate bash -c "( cd $GOPATH/src && protoc --java_out=gomatcha.io/matcha/android/MatchaLib/matcha/src/main/java gomatcha.io/matcha/pb/*.proto )"
//go:generate bash -c "( cd $GOPATH/src && protoc --java_out=gomatcha.io/matcha/android/MatchaLib/matcha/src/main/java gomatcha.io/matcha/pb/app/*.proto )"
//go:generate bash -c "( cd $GOPATH/src && protoc --java_out=gomatcha.io/matcha/android/MatchaLib/matcha/src/main/java gomatcha.io/matcha/pb/env/*.proto )"
//go:generate bash -c "( cd $GOPATH/src && protoc --java_out=gomatcha.io/matcha/android/MatchaLib/matcha/src/main/java gomatcha.io/matcha/pb/keyboard/*.proto )"
//go:generate bash -c "( cd $GOPATH/src && protoc --java_out=gomatcha.io/matcha/android/MatchaLib/matcha/src/main/java gomatcha.io/matcha/pb/layout/*.proto )"
//go:generate bash -c "( cd $GOPATH/src && protoc --java_out=gomatcha.io/matcha/android/MatchaLib/matcha/src/main/java gomatcha.io/matcha/pb/paint/*.proto )"
//go:generate bash -c "( cd $GOPATH/src && protoc --java_out=gomatcha.io/matcha/android/MatchaLib/matcha/src/main/java gomatcha.io/matcha/pb/text/*.proto )"
//go:generate bash -c "( cd $GOPATH/src && protoc --java_out=gomatcha.io/matcha/android/MatchaLib/matcha/src/main/java gomatcha.io/matcha/pb/touch/*.proto )"
//go:generate bash -c "( cd $GOPATH/src && protoc --java_out=gomatcha.io/matcha/android/MatchaLib/matcha/src/main/java gomatcha.io/matcha/pb/view/*.proto )"
//go:generate bash -c "( cd $GOPATH/src && protoc --java_out=gomatcha.io/matcha/android/MatchaLib/matcha/src/main/java gomatcha.io/matcha/pb/view/android/*.proto )"
